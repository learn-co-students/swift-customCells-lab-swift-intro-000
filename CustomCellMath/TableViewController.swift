...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let numList = numbers[indexPath.row]
        cell.firstNumberLabel.text? = String(numList[0])
        cell.secondNumberLabel.text? = String(numList[1])
        cell.thirdNumberLabel.text? = String(numList[2])
        cell.fourthNumberLabel.text? = String(numList[3])
